        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <!-- 价格结构 -->
              <ul class="sui-nav">
                <li :class="{ active: isOne }" @click="changeOrder('1', 1)">
                  <a>
                    综合
                    <span v-show="isOne" class="iconfont icon-angle-double-down" :class="{
                        'icon-angle-double-down': isDesc,
                        'icon-angle-double-up': isAsc,
                      }"></span>
                  </a>
                </li>
                <li :class="{ active: isTwo }" @click="changeOrder('2', 1)">
                  <a>价格
                    <span v-show="isTwo" class="iconfont" :class="{
                        'icon-angle-double-down': isDesc,
                        'icon-angle-double-up': isAsc,
                      }"></span>
                  </a>
  ...
  export default {
    ...
    methods: {
      ...
      attrInfo(attr, attrValue) {
        ...
        // this.searchParams.props = this.noRepeat(this.searchParams.props);
