<template>
  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul class="list clearFix" v-for="(order,index) in orderInfo.detailArrayList " :key="order.skuId">
          <li>
            <img :src="order.imgUrl" alt="" style="height:100px ;width: 100px;">
          </li>
          <li>
            <p style="width: 500px;">
              {{order.skuName}}</p>
    ...
    <div class="trade">
      <div class="price">应付金额:　<span>¥{{totalPrice||0}}</span></div>
...
<script>
  ...
  export default
  {
    ...
    computed:
    {
      ...
      {
        let totalNum = 0;
        if (this.orderInfo.detailArrayList)
        {
          this.orderInfo.detailArrayList.forEach(item => totalNum += item.skuNum)
        }
        return totalNum
      },
      totalPrice()
      {
        ...
        if (this.orderInfo.detailArrayList)
        {
          this.orderInfo.detailArrayList.forEach(item => totalPrice += item.orderPrice * item.skuNum)
        }
        return totalPrice
      }
    },
